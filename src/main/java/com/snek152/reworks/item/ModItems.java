...
public class ModItems {
    public static final RegistryObject<Item> AQUAMARINE = Registration.ITEMS.register("aquamarine",
            () -> new Aquamarine(new Item.Properties().tab(ItemGroup.TAB_MATERIALS).rarity(Rarity.UNCOMMON).stacksTo(1)));
    ...
    public static final RegistryObject<Item> RUBY = Registration.ITEMS.register("ruby",
            () -> new Ruby(new Item.Properties().tab(ItemGroup.TAB_MATERIALS).rarity(Rarity.UNCOMMON).fireResistant().stacksTo(1)));
